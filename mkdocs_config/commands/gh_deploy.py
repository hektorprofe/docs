...
def minify():
    log.info('Minificando... Bueno no :P')
    # for x in os.walk("C:\\Users\\hcost\\Projects\\docs_hektorprofe\\site"):
...
def _check_version(branch):
    ...
    if not previousv:
        log.warn(
            'Version check skipped: No version specificed in previous deployment.')
